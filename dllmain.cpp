...
static constexpr GUID GUIDPlugin_ADF = {0x8040a29e, 0x0754, 0x4ed7, {0xa5, 0x32, 0x36, 0x88, 0xe0, 0x8f, 0xff, 0x41}};
...
__declspec(dllexport) UINT WINAPI VFS_BatchOperationW(cADFPluginData* hData,
                                                      LPVFSFUNCDATA lpVFSData,
                                                      LPWSTR lpszPath,
...
__declspec(dllexport) bool VFS_GetFreeDiskSpaceW(cADFPluginData* hData,
                                                 LPVFSFUNCDATA lpFuncData,
                                                 LPWSTR lpszPath,
...
__declspec(dllexport) cADFFindData* WINAPI VFS_FindFirstFileW(cADFPluginData* hData,
                                                              LPVFSFUNCDATA lpVFSData,
                                                              LPWSTR lpszPath,
...
__declspec(dllexport) BOOL WINAPI VFS_ExtractFilesW(cADFPluginData* hData,
                                                    LPVFSFUNCDATA lpFuncData,
...
VFS_GetFileInformationW(cADFPluginData* hData, LPVFSFUNCDATA lpVFSData, LPWSTR lpszPath, HANDLE hHeap, DWORD dwFlags);
};
...
BOOL VFS_ExtractFilesW(cADFPluginData* hData, LPVFSFUNCDATA lpFuncData, LPVFSEXTRACTFILESDATA lpExtractData) {
  return hData->ExtractEntries(lpFuncData, dopus::wstring_view_span(lpExtractData->lpszFiles),
